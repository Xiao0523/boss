    ...
    <el-table :data="list" :header-cell-style="tabHeader" class="table-box" border>
      ...
      <el-table-column align="center" label="操作">
        <template slot-scope="scope">
          <router-link :to="{name: 'OrganizationAudit', query:{id: scope.row.id}}">
            <el-button v-if="!scope.row.status" type="danger" size="mini" @click="audit(scope.$index, scope.row)">审核</el-button>
          </router-link>
        </template>
      </el-table-column>
    </el-table>
