<template>
  <div>
    ...
    >
      ...
      <el-row>
        <el-form-item>
          <el-button type="primary" style=" text-align: center;" @click="onSubmit('ruleForm')">提交</el-button>
          <el-button type="info" style="left:100px" @click="cancel('ruleForm')">取消</el-button>
        </el-form-item>
      </el-row>
    </el-form>
  </div>
...
export default {
  ...
  methods: {
    ...
    onSubmit(formName) {
      ...
      const categoryId = this.ruleForm.category
