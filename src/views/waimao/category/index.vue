<template>
  <div>
    <el-row>
      <el-form :inline="true">
        <el-form-item>
          <el-input v-model.trim="keyWord" placeholder="请输入类目名称" clearable style="width: 400px;"/>
        </el-form-item>
        <el-button type="primary" style="margin-left: 80px" @click="search">搜索</el-button>
        <el-button type="primary" style="margin-left: 80px" @click="newCategory">新增类目</el-button>
      </el-form>
    </el-row>
    <el-table :data="Category" :header-cell-style="tabHeader" class="table-box" border>
      <el-table-column align="center" prop="categoryName" label="类目名称"/>
      <el-table-column align="center" prop="articleNum" label="文章数"/>
    ...
    <el-dialog :title="operationType" :visible.sync="isShow" width="30%">
      <el-form ref="form" label-position="left">
        ...
        <el-form-item label="排序">
          <el-input v-model="orderIndex" type="number" />
        </el-form-item>
      </el-form>
