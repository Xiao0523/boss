<template>
  <div>
    <el-table :data="list" :header-cell-style="tabHeader" class="table-box" border>
      ...
      <el-table-column align="center" prop="statusDescription" label="课程状态描述" />
      <el-table-column align="center" prop="storeName" label="店铺名字" />
    </el-table>
  </div>
</template>
<script>
import { getStudentCousor } from '@/api/member'
export default {
  ...
  methods: {
    fetchList(id) {
      ...
      getStudentCousor(getObj).then(res => {
