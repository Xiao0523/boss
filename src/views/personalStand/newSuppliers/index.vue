  ...
  <div>
    ...
    >
      ...
      <el-form-item label="姓名" prop="personName">
        <el-input v-model="ruleForm.personName" style="width: 500px;" placeholder="请填写姓名"/>
      </el-form-item>
      <el-form-item label="公司名称" prop="companyName">
        <el-input v-model="ruleForm.companyName" style="width: 500px;" placeholder="请填写公司名称"/>
      </el-form-item>
      <el-form-item label="手机号" prop="mobilePhone">
        <el-input v-model="ruleForm.mobilePhone" style="width: 500px;" placeholder="请填写手机号"/>
      </el-form-item>
...
import { editSupplier } from '@/api/personSuppliers'
