<template>
  <section>
    ...
    <Dialog
      ...
      @confirmFn="confirmFn"
    >
      <label class="btn" for="uploads2">选择图片</label>
      <input type="file" id="uploads2" ref="file" style="position:absolute; clip:rect(0 0 0 0);"
             accept="image/png, image/jpeg, image/gif, image/jpg" @change="uploadImg2($event, 1)">
