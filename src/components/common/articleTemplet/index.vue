<template>
  <div>
      ...
      <div class="left">
        <el-form :label-position="labelPosition" :model="fromMenu" label-width="100px">
          ...
          <el-form-item label="提成金额">
            <el-input v-model="fromMenu.money"/>
          </el-form-item>
          <el-form-item label="来源">
            <el-input v-model="fromMenu.source"/>
          </el-form-item>
    ...
    <section class="coverimgBox">
      <!--单张封面-->
      <coverCrop v-if="fromMenu.layout ==0 || fromMenu.layout ==1" :image-url="imageUrl" @uploadFileFn="uploadFileFn1"/>
      <!--多张封面-->
    ...
    <Tinymce v-model="fromMenu.introduce"/>
    <previewDialog
      :is-show="visible"
      :title="'预览'"
    ...
    >
      <section class="previewContent" v-html="fromMenu.introduce"/>
    </previewDialog>
